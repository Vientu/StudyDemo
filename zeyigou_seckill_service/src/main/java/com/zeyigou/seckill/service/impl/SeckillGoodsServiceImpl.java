...
import com.zeyigou.pojo.TbSeckillGoodsExample.Criteria;
import com.zeyigou.seckill.service.SeckillGoodsService;
	...
	public List<TbSeckillGoods> findAll() {
		...
		if (seckillList == null || seckillList.size()==0){
			...
			for (TbSeckillGoods seckillGoods : seckillList) {
				redisTemplate.boundHashOps("seckillList").put(seckillGoods.getId(),seckillGoods);
			}
